...
function normalize_config(config) {
    ...
    function map_traffic_rule_traffic_type(traffic_types) {
        ...
        return _.map(traffic_types, function (traffic_type) {
    ...
    network_traffic_rules = _.concat([], network_traffic_rules, _.map(_.keys(normalized_network_tiers), function (network_tier) {
        return {
        ...
        _.each(source_tier_traffic_rules, function (traffic_type_traffic_rules) {
            _.each(traffic_type_traffic_rules, function (traffic_rule) {
                ...
                if (!source_tier.is_known_cidr_range) {
                    ...
                    let traffic_rule_network_tier_type = destination_tier.is_known_cidr_range ? 'cidr_block' : 'network_tier';
                ...
                if (!destination_tier.is_known_cidr_range) {
                    ...
                    let traffic_rule_network_tier_type = source_tier.is_known_cidr_range ? 'cidr_block' : 'network_tier';
